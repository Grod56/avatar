/* eslint-disable import/extensions, import/no-extraneous-dependencies, jsdoc/require-jsdoc, node/no-missing-import, linebreak-style */
...
test('sourceLogic: useGravatar', (t) => {
  ...
  t.true(
    setSource.calledWith(
      'https://secure.gravatar.com/avatar/test?s=80&d=test&r=test&f=y',
    ),
  );
});
...
test('sourceLogic: githubId', (t) => {
  ...
  t.true(
    setSource.calledWith(
      'https://avatars.githubusercontent.com/u/test?s=test&v=4',
    ),
  );
});
...
test('sourceLogic: initials', (t) => {
  ...
  t.true(
    setSource.calledWith(
      'data:image/png;base64,',
    ),
  );
});
